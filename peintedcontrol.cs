...
{
    public partial class peintedcontrol : UserControl
    {

        public peintedcontrol()
        {
            InitializeComponent();
        }
        public int w;
        ...
        private void peintedcontrol_Paint(object sender, PaintEventArgs e)
        {
            try
            {
        ...
        private void peintedcontrol_Load(object sender, EventArgs e)
        {
            //g = CreateGraphics();
        ...
        private void peintedcontrol_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void peintedcontrol_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void peintedcontrol_Enter(object sender, EventArgs e)
        {
            setthedebugtext();
        }

        private void peintedcontrol_MouseDown(object sender, MouseEventArgs e)
        {
            previewsX = e.X;
            previewsY = e.Y;
            setthedebugtext();
        ...
        private void peintedcontrol_MouseUp(object sender, MouseEventArgs e)
        {
            lastX = e.X;
            lastY = e.Y;
            setthedebugtext();
